...
#TARGETS  = setup   encryption   keygeneration   decryption
...
#
#setup: setup.o common.o
#	$(CC) -o $@ $^ $(LDFLAGS)

#encryption: enc.o common.o policy_lang.o
#	$(CC) -o $@ $^ $(LDFLAGS)

#keygeneration: keygen.o common.o policy_lang.o
#	$(CC) -o $@ $^ $(LDFLAGS)

#decryption: dec.o common.o
#	$(CC) -o $@ $^ $(LDFLAGS)
